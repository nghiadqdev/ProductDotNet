...
namespace Eshop.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public IActionResult Index(DateTime? date)
        {
            ...
            if (date == null)
            {
                invoices = _context.Invoices.Include(i => i.Account).ToList();
            }
            else
            {
                invoices = _context.Invoices.Include(i => i.Account)
                                            .Where(i => i.IssuedDate >= date && i.IssuedDate < date.Value.AddDays(1)).ToList();
            }

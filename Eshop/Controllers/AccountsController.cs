...
namespace Eshop.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public IActionResult Login(string Username, string Password)
        {
            ...
            if (account != null)    // Đăng nhập thành công
            {
                HttpContext.Response.Cookies.Append("tenTK", Username);
                HttpContext.Response.Cookies.Append("hoTen", account.FullName);
            }
        ...
        public IActionResult Logout()
        {
            ...
            //HttpContext.Response.Cookies.Append("tenTK", "", options);
            //HttpContext.Response.Cookies.Append("hoTen", "", options);
        ...
        public IActionResult Login2(string Username, string Password)
        {
            ...
            if (account != null)    // Đăng nhập thành công
            {
                HttpContext.Session.SetString("tenTK", Username);
                HttpContext.Session.SetString("hoTen", account.FullName);
            }
            else // Đăng nhập thất bại
            {
                ViewBag.Msg = "Đăng nhập thất bại";
